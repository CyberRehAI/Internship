"""
Train TranAD-style transformer baseline (default: concat).

Usage (from AI-TDP root):
  python -m baselines.train.train_tranad --mode concat
"""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Train TranAD baseline")
